...
/*When dddddd npm run test:watchoing these tasks, we recommend using console.log to test the output of your code to make sure it works correctly.*/
...
// console.log(createMenuItem("tacos", 8, "Lunch")); create pet
...
console.log(createMenuItem("chips", 4, "Lunch"));
...
Using the burger object below do the following:
  1. Add a method called discount to the burger object (function discount)
  ...
  For example: burger.discount("teacher") would return 13.5 and burger.discount("public") would return 16.2 j
*/
...
export const burger = {
  ...
  price: 18,
  category: "Lunch",
  discount: function (teacher, student) {
    if (teacher) {
      return 13.5;
    } else if (student) {
      return 13.5;
...
function getReviewByIndex(array, index) {
  ...
  let statement = `${item.name} gave the restaurant a ${item.rating} star review, and their feedback was: ${item.feedback}`;
  return statement;
}
...
function getLastReview(array) {
  ...
  let string = `${last.name} gave the restaurant a ${last.rating} star review, and their feedback was: ${last.feedback}`;
  return string;
}
